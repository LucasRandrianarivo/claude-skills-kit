...
/pr-review --all-specialists  — force-dispatch all eleven specialists
/pr-review --security         — force-include one specialist (also: --red-team,
                                ...
                                --frontend-perf, --integration, --database)
```
...
- **`--all-specialists`**: dispatch all eleven specialists.
...
| Schema/model files, migrations, repositories, queries (SQL or ORM), or handlers reading/writing persistent data | `specialist-database` |
